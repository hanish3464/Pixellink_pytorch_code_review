...
###added version + batch size / epoch / iteration####
...
parser.add_argument('--iter', type=int, default=1500, help='value is the num of iteration')
...
#    print("[def:main][GPU check]")
    ...
    iteration = 0
#    print("[def:train]")
#    print("epoch: {} batch_size {} iteration : {}".format(config.epoch, config.batch_size, config.iteration))
...
#        print("config.epoch : {} config.batch_size : {}, config.iteration : {}".format(config.epoch, config.batch_size, config.iteration))
